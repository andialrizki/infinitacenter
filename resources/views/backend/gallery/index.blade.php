                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#"
                                            onclick="edit('{{ $item->id }}', '{{ $item->category_id }}', '{{ $item->sort }}','{{ $item->status }}','{{ $item->title }}','{{ $item->desc_id }}','{{ $item->image }}')"><i
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">Gallery Form</h4>
                                                            ...
                                                            <div class="media flex-column flex-md-row">
                                                                ...
                                                                <div class="media-body">
                                                                    <small class="text-muted">Silahkan upload file
                                                                        berukuran 600 x 600 pixel</small>
...
@push('js')
    <script>
        ...
        function multideleted() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('gallery.multi_delete') }}",
                        data: {
                            id: id
                        },
                        success: function(result) {
        ...
        function updateStatus(id) {
            var sts;
            var url = "{{ '/webmin/gallery/status/' }}" + id;
        ...
        //edit
        function edit(id, category_id, sort, sts, title, desc, image) {
            $('#id').val(id);
