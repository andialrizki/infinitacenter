            ...
            <div class="row p-2">
                ...
                <div class="input-group mb-2 col-xxl-6 col-xl-6 col-lg-6 col-12">
                    ...
                    <div class="btn-group float-end pl-2" role="group">
                        <button data-toggle="modal" data-target="#addData" class="btn btn-primary"><i
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#"
                                            onclick="edit('{{ $item->id }}','{{ $item->sort }}','{{ $item->status }}','{{ $item->title }}','{{ $item->desc }}','{{ $item->image }}','{{ $item->content_url }}')"><i
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">Banner Home Form</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="content_url" class="form-control"
                                                                placeholder="Content URL" name="sort" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
...
@push('js')
    <script>
        ...
        function deleted(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ '/webmin/banner-home/delete/' }}" + id,
                        data: {
                            id: id
                        },
        ...
        function multideleted() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('banner-home.multi_delete') }}",
                        data: {
                            id: id
                        },
                        success: function(result) {
        ...
        function updateStatus(id) {
            var sts;
            var url = "{{ '/webmin/banner-home/status/' }}" + id;
        ...
        function addData() {
            ...
            if ($('#sort').val() == '' || $('#statusForm').val() == '' || $('#title').val() == '' || $('#thumbnail')
                ...
                var url = "{{ route('banner-home.create') }}";
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: {
        ...
        //edit
        function edit(id, sort, sts, title, desc, image, content_url) {
            $('#id').val(id);
            $('#sort').val(sort);
