            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">Services Form</h4>
                                        ...
                                        <div class="card-body">
                                            <form class="form" id="formData">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            <label for="icon">Icon Keyword</label>
                                                            <input type="text"
                                                                id="icon" class="form-control" placeholder="Icon Keyword"
                                                                name="icon" required />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-12">
...
@push('js')
    <script>
        ...
        function multideleted() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('services.multi_delete') }}",
                        data: {
                            id: id
                        },
                        success: function(result) {
        ...
        function updateStatus(id) {
            var sts;
            var url = "{{ '/webmin/services/status/' }}" + id;
        ...
        function addData() {
            ...
            if ($('#sort').val() == '' || $('#statusForm').val() == '' || $('#title').val() == '' || $('#icon')
            .val() == '') {
                Swal.fire({
                    title: 'Error!',
        ...
        //edit
        function edit(id) {
            var url = "{{ '/webmin/services/edit/' }}" + id;
            $.ajax({
                type: 'GET',
                url: url,
                success: function(data) {
