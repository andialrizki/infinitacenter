            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">News Form</h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="description" class="form-control" placeholder="Description ID" id="description" required></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
                                                            <label for="description_en">Description EN</label>
                                                            <textarea name="description_en" class="form-control" placeholder="Description EN" id="description_en" required></textarea>
                                                        </div>
                                                    </div>
...
@push('js')
    <script>
        ...
        function addData() {
            ...
            if ($('#statusForm').val() == '' || $('#title').val() == '' || $('#thumbnail').val() == '') {
                Swal.fire({
                    title: 'Error!',
        ...
        function edit(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    CKEDITOR.instances['description'].setData(data.data[0].desc_id);
                    CKEDITOR.instances['description_en'].setData(data.data[0].desc_en);
