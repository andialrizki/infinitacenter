            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">Gallery Category Form</h4>
...
@push('js')
    <script>
        ...
        function deleted(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ '/webmin/gallery-category/delete/' }}" + id,
                        data: {
                            id: id
                        },
        ...
        function multideleted() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('gallery-category.multi_delete') }}",
                        data: {
                            id: id
                        },
                        success: function(result) {
        ...
        function updateStatus(id) {
            var sts;
            var url = "{{ '/webmin/gallery-category/status/' }}" + id;
        ...
        function addData() {
            ...
            if ($('#sort').val() == '' || $('#statusForm').val() == '' || $('#title').val() == '') {
                ...
                var url = "{{ route('gallery-category.create') }}";
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: {
        ...
        //edit
        function edit(id) {
            var url = "{{ '/webmin/gallery-category/edit/' }}" + id;
            $.ajax({
                type: 'GET',
                url: url,
                success: function(data) {
