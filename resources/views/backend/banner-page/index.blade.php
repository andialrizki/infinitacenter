                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#"
                                            onclick="edit('{{ $item->id }}','{{ $item->sort }}','{{ $item->status }}','{{ $item->title }}',`{{ $item->desc }}`,'{{ $item->image }}')"><i
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel17">Banner Page Form</h4>
...
@push('js')
    <script>
        ...
        function deleted(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ '/webmin/banner-page/delete/' }}" + id,
                        data: {
                            id: id
                        },
        ...
        function multideleted() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('banner-page.multi_delete') }}",
                        data: {
                            id: id
                        },
                        success: function(result) {
        ...
        function updateStatus(id) {
            var sts;
            var url = "{{ '/webmin/banner-page/status/' }}" + id;
        ...
        function addData() {
            ...
            .val() == '') {
                ...
                var url = "{{ route('banner-page.create') }}";
                $.ajax({
                    type: 'POST',
                    url: url,
                    data: {
        ...
        //edit
        function edit(id, sort, sts, title, desc, image) {
            $('#id').val(id);
            $('#sort').val(sort);
